...
/*
    ...
    Cmdline: sokol-shdc --input shd_combo.glsl --output genshd_combo.h --slang glsl330
        ...
        Shader program 'shdobj':
            ...
            Fragment shader: fs_obj
                ...
                Uniform block 'fs_obj_dirlight':
                    ...
                    Bind slot: SLOT_fs_obj_dirlight = 2
                Uniform block 'fs_obj_spotlight':
                    C struct: fs_obj_spotlight_t
                    Bind slot: SLOT_fs_obj_spotlight = 3
                Image 'imgdiff':
...
#pragma pack(pop)
#define SLOT_fs_obj_spotlight (3)
#pragma pack(push,1)
...
/*
    ...
    {
        vec3 _246 = normalize(-light.dir);
        return ((light.ambi * lightdata.pixdiff) + ((light.diff * max(dot(lightdata.normal, _246), 0.0)) * lightdata.pixdiff)) + ((light.spec * pow(max(dot(lightdata.viewdir, reflect(-_246, lightdata.normal)), 0.0), lightdata.matshine)) * lightdata.pixspec);
    }
    ...
    {
        vec3 _292 = light.pos - lightdata.fragpos;
        vec3 _293 = normalize(_292);
        float _315 = length(_292);
        float _328 = 1.0 / ((light.constant + (light.linear * _315)) + (light.quadratic * (_315 * _315)));
        return (((light.ambi * lightdata.pixdiff) * _328) + (((light.diff * max(dot(lightdata.normal, _293), 0.0)) * lightdata.pixdiff) * _328)) + (((light.spec * pow(max(dot(lightdata.viewdir, reflect(-_293, lightdata.normal)), 0.0), lightdata.matshine)) * lightdata.pixspec) * _328);
    }
    ...
    {
        vec3 _364 = light.pos - lightdata.fragpos;
        vec3 _365 = normalize(_364);
        float _387 = length(_364);
        float _439 = (1.0 / ((light.constant + (light.linear * _387)) + (light.quadratic * (_387 * _387)))) * clamp((dot(_365, normalize(-light.dir)) - light.outcutoff) / (light.cutoff - light.outcutoff), 0.0, 1.0);
        return (((light.ambi * lightdata.pixdiff) * _439) + (((light.diff * max(dot(lightdata.normal, _365), 0.0)) * lightdata.pixdiff) * _439)) + (((light.spec * pow(max(dot(lightdata.viewdir, reflect(-_365, lightdata.normal)), 0.0), lightdata.matshine)) * lightdata.pixspec) * _439);
    }
    
    void main()
    {
        lightdata_t _477 = lightdata_t(vec3(texture(imgdiff, inter.uv).xyz), vec3(texture(imgspec, inter.uv).xyz), normalize((vec3(texture(imgnorm, inter.uv).xyz) * 2.0) - vec3(1.0)), inter.tang_fragpos, normalize(inter.tang_viewpos - inter.tang_fragpos), fs_obj_fast[0].x);
        vec3 result = calc_dir_light(get_directional_light(), _477);
        int _136 = int(fs_obj_pointlights[16].x);
        for (int i = 0; i < 4; i++)
        {
            if ((_136 & (1 << i)) != 0)
            {
        ...
        vec3 _164 = result;
        vec3 _165 = _164 + calc_spot_light(get_spot_light(), _477);
        result = _165;
        frag = vec4(_165, 1.0);
    }
    
*/
static const char fs_obj_source_glsl330[4097] = {
    ...
    0x6a,0x5f,0x66,0x61,0x73,0x74,0x5b,0x31,0x5d,0x3b,0x0a,0x75,0x6e,0x69,0x66,0x6f,
    0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x66,0x73,0x5f,0x6f,0x62,0x6a,0x5f,0x70,
    0x6f,0x69,0x6e,0x74,0x6c,0x69,0x67,0x68,0x74,0x73,0x5b,0x31,0x37,0x5d,0x3b,0x0a,
    0x75,0x6e,0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0
0x20,0x66,0x73,0x5f,0x6f,0x62,0x6a,0x5f,0x73,0x70,
    ...
    0x5d,0x2e,0x78,0x2c,0x20,0x66,0x73,0x5f,0x6f,0x62,0x6a,0x5f,0x73,0x70,0x6f,0x74,
    0x6c,0x69,0x67,0x68,0x74,0x5b,0x30,0x5d,0x2e,0x79,0x2c,0x20,0x66,0x73,0x5f,0x6f,
    0x62,0x6a,0x5f,0x73,0x70,0x6f,0x74,0x6c,0x69,0x67,0x68,0x74,0x5b,0x30,0x5d,0x2e,
    0x7a,0x2c,0x20,0x66,0x73,0x5f,0x6f,0x62,0x6a,0x5f,0x73,0x70,0x6f,0x74,0x6c,0x69,
    0x67,0x68,0x74,0x5b,0x31,0x5d,0x2e,0x78,0x79,0x7a,0x2c,0x20,0x66,0x73,0x5f,0x6f,
    0x62,0x6a,0x5f,0x73,0x70,0x6f,0x74,0x6c,0x69,0x67,0x68,0x74,0x5b,0x32,0x5d,0x2e,
    0x78,0x79,0x7a,0x2c,0x20,0x66,0x73,0x5f,0x6f,0x62,0x6a,0x5f,0x73,0x70,0x6f,0x74,
    ...
    0x29,0x0a,0x7b,0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x33,0x20,0x5f,0x33,0x36,
    ...
    0x73,0x3b,0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x33,0x20,0x5f,0x33,0x36,0x35,
    0x20,0x3d,0x20,0x6e,0x6f,0x72,0x6d,0x61,0x6c,0x69,0x7a,0x65,0x28,0x5f,0x33,0x36,
    0x34,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x33,
    0x38,0x37,0x20,0x3d,0x20,0x6c,0x65,0x6e,0x67,0x74,0x68,0x28,0x5f,0x33,0x36,0x34,
    ...
    0x69,0x67,0x68,0x74,0x2e,0x6c,0x69,0x6e,0x65,0x61,0x72,0x20,0x2a,0x20,0x5f,0x33,
    0x38,0x37,0x29,0x29,0x20,0x2b,0x20,0x28,0x6c,0x69,0x67,0x68,0x74,0x2e,0x71,0x75,
    0x61,0x64,0x72,0x61,0x74,0x69,0x63,0x20,0x2a,0x20,0x28,0x5f,0x33,0x38,0x37,0x20,
    0x2a,0x20,0x5f,0x33,0x38,0x37,0x29,0x29,0x29,0x29,0x20,0x2a,0x20,0x63,0x6c,0x61,
    0x6d,0x70,0x28,0x28,0x64,0x6f,0x74,0x28,0x5f,0x33,0x36,0x35,0x2c,0x20,0x6e,0x6f,
    ...
    0x69,0x66,0x66,0x29,0x20,0x2a,0x20,0x5f,0x34,0x33,0x39,0x29,0x20,0x2b,0x20,0x28,
    ...
    ,
    ...
    0x5f,0x6f,0x62,0x6a,0x5f,0x66,0x61,0x73,0x74,0x5b,0x30,0x5d,0x2e,0x78,0x29,0x3b,
    ...
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x6e,0x74,0x20,0x5f,0x31,0x33,0x36,0x20,0x3d,
    0x20,0x69,0x6e,0x74,0x28,0x66,0x73,0x5f,0x6f,0x62,0x6a,0x5f,0x70,0x6f,0x69,0x6e,
    ...
    0x20,0x28,0x28,0x5f,0x31,0x33,0x36,0x20,0x26,0x20,0x28,0x31,0x20,0x3c,0x3c,0x20,
    ...
    0x31,0x36,0x34,0x20,0x3d,0x20,0x72,0x65,0x73,0x75,0x6c,0x74,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x76,0x65,0x63,0x33,0x20,0x5f,0x31,0x36,0x35,0x20,0x3d,0x20,0x5f,0x31,
    0x36,0x34,0x20,0x2b,0x20,0x63,0x61,0x6c,0x63,0x5f,0x73,0x70,0x6f,0x74,0x5f,0x6c,
    ...
    0x20,0x20,0x72,0x65,0x73,0x75,0x6c,0x74,0x20,0x3d,0x20,0x5f,0x31,0x36,0x35,0x3b,
    0x0a,0x20,0x20,0x20,0x20,0x66,0x72,0x61,0x67,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,
    0x28,0x5f,0x31,0x36,0x35,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,
    0x00,
};
/*
    #version 330
...
static inline const sg_shader_desc* shdobj_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.fs.uniform_blocks[0].uniforms[0].name = "fs_obj_fast";
